      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item active open">
            ...
            <ul class="menu-sub">
  <li class="menu-item<?php if (basename($_SERVER['PHP_SELF']) === 'add-blog.php') echo ' active'; ?>">
    <a href="add-blog.php" class="menu-link">
      <div data-i18n="Basic Inputs">Post Blogs</div>
    </a>
  </li>
  <li class="menu-item<?php if (basename($_SERVER['PHP_SELF']) === 'upload-gallery.php') echo ' active'; ?>">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row">
              ...
              <form action="save-photo.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  <label for="photoTitle" class="form-label">Photo Title (optional)</label>
                  <input type="text" class="form-control" name="title" id="blogAuthor" required />
                </div>
