            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        ...
                        <div class="mb-5">
                            <img class="img-fluid rounded w-100 mb-4" src="<?= htmlspecialchars($blog['image_path']) ?>" alt="Blog Image">
                            <h2><?= htmlspecialchars($blog['title']) ?></h2>
                            <p><strong>By <?= htmlspecialchars($blog['author']) ?> on <?= date('F j, Y', strtotime($blog['published_at'])) ?></strong></p>
