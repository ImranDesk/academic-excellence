...
<head>
    <meta charset="UTF-8">
    <title><?= htmlspecialchars($blog['title']) ?> | Edukate</title>
...
<div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
    <div class="container text-center py-5">
        <h1 class="text-white display-1"><?= htmlspecialchars($blog['title']) ?></h1>
        <div class="d-inline-flex text-white">
            <p class="m-0 text-uppercase"><a class="text-white" href="index.php">Home</a></p>
            <i class="fa fa-angle-double-right pt-1 px-3"></i>
            <p class="m-0 text-uppercase">Blog Details</p>
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <?php if (!empty($blog['image'])): ?>
                    <img src="<?= htmlspecialchars($blog['image']) ?>" alt="Blog Image" class="img-fluid mb-4" style="max-width:100%; width:100%; height:auto;">
                <?php endif; ?>
            ...
            <div class="col-lg-4 mt-5 mt-lg-0">
                <div class="mb-5">
                    ...
                    <?php foreach ($recentBlogs as $recent): ?>
                        <a class="d-flex align-items-center text-decoration-none mb-4" href="blog-details.php?id=<?= $recent['id'] ?>">
                            <?php if (!empty($recent['image'])): ?>
                                <img class="img-fluid rounded" src="<?= htmlspecialchars($recent['image']) ?>" alt="" style="width: 80px; height: 80px; object-fit: cover;">
                            <?php endif; ?>
                            <div class="pl-3">
